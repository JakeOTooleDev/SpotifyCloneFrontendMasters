/*
  ...
  - You are about to drop the column `email` on the `Song` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Song" DROP COLUMN "email",
